    ...
    <div style={{ background: "#FFF8E7" }}>
      <section className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            ...
            <p className="text-lg mb-8" style={{ color: "#6B5F45", fontFamily: "Inter, sans-serif" }}>
            ...
            <a href="https://wa.me/919860810865?text=I%20want%20AI%20Automation%20for%20my%20business" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold text-base transition-all hover:scale-105" style={{ background: "#1A1A1A", color: "#FFF8E7", fontFamily: "Sora, sans-serif" }}>
          ...
          <ScrollReveal delay={150}>
            <div className="rounded-3xl p-8 border" style={{ background: "#FBF1DD", borderColor: "#E5DCC8" }}>
              <p className="text-xs font-bold uppercase tracking-wider mb-6 text-center" style={{ color: "#C9A24B", fontFamily: "Sora, sans-serif" }}>Automation Flow</p>
              <div className="flex flex-col gap-3">
                {flowSteps.map((step, i) => (
                  <div key={step.label}>
                    <div className="rounded-xl px-5 py-3 text-sm font-bold text-center" style={{ background: step.color, color: step.color === "#C9A24B" ? "#111111" : "#FFF8E7", fontFamily: "Sora, sans-serif" }}>
                      {step.label}
                    </div>
      ...
      <section className="py-20 px-4 md:px-8" style={{ background: "#FBF1DD" }}>
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <h2 className="text-3xl md:text-4xl font-black text-center mb-12" style={{ color: "#000000", fontFamily: "Sora, sans-serif" }}>What We Offer</h2>
          </ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <ScrollReveal key={f.title} delay={i * 80}>
                <div className="rounded-2xl p-7 border h-full hover:shadow-lg transition-all hover:scale-[1.02]" style={{ background: "#FFF8E7", borderColor: "#E5DCC8" }}>
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        <ScrollReveal>
          <h2 className="text-3xl font-black text-center mb-12" style={{ color: "#000000", fontFamily: "Sora, sans-serif" }}>Value Delivered</h2>
        </ScrollReveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <ScrollReveal key={v.label} delay={i * 100}>
              <div className="rounded-2xl p-8 border text-center h-full" style={{ background: "#FBF1DD", borderColor: "#E5DCC8" }}>
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ background: "#C9A24B" }}>
                  <v.icon size={22} style={{ color: "#1A1A1A" }} />
                </div>
                <div className="text-3xl font-black mb-2" style={{ color: "#C9A24B", fontFamily: "Sora, sans-serif" }}>{v.stat}</div>
                <h3 className="text-base font-black mb-2" style={{ color: "#000000", fontFamily: "Sora, sans-serif" }}>{v.label}</h3>
      ...
      <section className="py-20 px-4 md:px-8" style={{ background: "#1A1A1A" }}>
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-4xl font-black mb-4" style={{ color: "#FFF8E7", fontFamily: "Sora, sans-serif" }}>Ready to Automate?</h2>
          <p className="text-base mb-8" style={{ color: "#B8A98A", fontFamily: "Inter, sans-serif" }}>Get your automation system live in 1–3 days.</p>
          <a href="https://wa.me/919860810865?text=I%20want%20AI%20Automation" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold text-base transition-all hover:scale-105" style={{ background: "#C9A24B", color: "#111111", fontFamily: "Sora, sans-serif" }}>
            Automate My Business <ArrowRight size={16} />
          </a>
        </div>
      </section>
