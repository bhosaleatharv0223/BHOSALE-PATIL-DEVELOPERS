    ...
    <div style={{ background: "#FFF8E7" }}>
      <section className="pt-32 pb-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            ...
            <a href="https://wa.me/919860810865?text=I%20want%20UI%2FUX%20Design" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold text-base transition-all hover:scale-105" style={{ background: "#1A1A1A", color: "#FFF8E7", fontFamily: "Sora, sans-serif" }}>
          ...
          <ScrollReveal delay={150}>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="rounded-xl p-4 border" style={{ background: "#E5DCC8", borderColor: "#D4C9B0" }}>
                  <div className="h-4 rounded mb-2" style={{ background: "#C4B99A", width: "70%" }} />
                  <div className="h-3 rounded mb-2" style={{ background: "#C4B99A", width: "90%" }} />
                  <div className="h-3 rounded mb-4" style={{ background: "#C4B99A", width: "60%" }} />
                  <div className="grid grid-cols-2 gap-2">
                    <div className="rounded h-12" style={{ background: "#B8A98A" }} />
                    <div className="rounded h-12" style={{ background: "#B8A98A" }} />
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="rounded-xl p-4 border shadow-lg" style={{ background: "#FBF1DD", borderColor: "#C9A24B" }}>
                  <div className="h-4 rounded mb-2" style={{ background: "#1A1A1A", width: "70%" }} />
                  <div className="h-3 rounded mb-2" style={{ background: "#E5DCC8", width: "90%" }} />
                  <div className="h-3 rounded mb-4" style={{ background: "#E5DCC8", width: "60%" }} />
                  <div className="grid grid-cols-2 gap-2">
                    <div className="rounded-lg h-12 flex items-center justify-center" style={{ background: "#1A1A1A" }}>
                      <Palette size={14} style={{ color: "#C9A24B" }} />
                    </div>
                    <div className="rounded-lg h-12" style={{ background: "#C9A24B" }} />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4 md:px-8" style={{ background: "#FBF1DD" }}>
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <h2 className="text-3xl font-black text-center mb-12" style={{ color: "#000000", fontFamily: "Sora, sans-serif" }}>Design Services</h2>
          </ScrollReveal>
      ...
      <section className="py-20 px-4 md:px-8" style={{ background: "#1A1A1A" }}>
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-4xl font-black mb-4" style={{ color: "#FFF8E7", fontFamily: "Sora, sans-serif" }}>Transform Your Design</h2>
          <p className="text-base mb-8" style={{ color: "#B8A98A", fontFamily: "Inter, sans-serif" }}>Polished, production-ready designs in 2–5 days.</p>
          <a href="https://wa.me/919860810865?text=I%20want%20UI%2FUX%20Design" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-bold" style={{ background: "#C9A24B", color: "#111111", fontFamily: "Sora, sans-serif" }}>
